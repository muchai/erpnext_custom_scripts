...
frappe.ui.form.on("Sales Invoice Item", "end_date", function (frm, cdt, cdn) {
    //End date validation on End date change
...
frappe.ui.form.on("Sales Invoice Item", "start_date", function (frm, cdt, cdn) {
    //End date validation on End date change
    end_date_start_date_validation(frm, cdt, cdn);
    //Days or Dates Calculation
    days_calculation(frm, cdt, cdn);
...
//frappe.ui.form.on("Sales Invoice Item", "days", function (frm, cdt, cdn) {
    //End date validation on End date change
    //end_date_start_date_validation(frm, cdt, cdn);
    //Days or Dates Calculation
